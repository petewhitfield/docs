...
#### <Icon icon="video" size={20} /> SIERRA Learning Series
...
#### <Icon icon="video" size={20} /> How to Research and Write Using Generative AI Tools
...
#### <Icon icon="video" size={20} /> Learning ChatGPT for Business Analysis
...
#### <Icon icon="video" size={20} /> Prompt Engineering: How to Talk to the AIs
...
| gpt-auto             | Dynamic model selection       | --            | --                      | --                  | --                  | --                   |
| gpt-5-thinking       | General purpose model         | **Yes**       | 272K Input, 128K Output | October 2024        | \$1.25              | \$10.00              |
| gpt-5-mini           | Faster general purpose model  | **Yes**       | 272K Input, 128K Output | May 2024            | \$0.25              | \$2.00               |
...
| grok-3-mini          | Lightweight reasoning model   | **Yes**       | 131K                    | November 2024       | \$0.25              | \$1.27               |

### <Icon icon="message-circle-question-mark" size={20} /> What are tokens?
...
### <Icon icon="message-circle-question-mark" size={20} /> What is the context window?
...
### <Icon icon="message-circle-question-mark" size={20} /> What is the training cutoff date?
