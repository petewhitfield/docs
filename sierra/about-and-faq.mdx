...
4. Task Prompts: Specific, reusable instructions built by workspace users to perform repeatable actions consistently.

Read more about workspaces in SIERRA [here](/articles/workspaces-got-smarter).
