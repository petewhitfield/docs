...
<div class="release-update">
  <Update label="February 25, 2026" tags={["Improvements"]}>
    - Added workspace memories and taks prompts
    - UX updates to improve workspace settings, context, and files
  </Update>
</div>

<div class="release-update">
  <Update label="February 13, 2026" tags={["Improvements, Bug Fixes"]}>
    - Imrpoved analytics leaderboard with department and company filtering
